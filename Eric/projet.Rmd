...
-> On remplace la (ou les) valeurs abÃ©rentes par NA (les valeurs aberantes etant $out)
...
NOTE : Cependant je n'est pas reussi à supprimer les NA present dans plus de n cases dans 
une colonne


-> On remplace les autres NA par la moyenne de leur colonne respectives

```{r}
#moyfin2 = mean (donneefin2bis, na.rm = T)
#moyfin
```
