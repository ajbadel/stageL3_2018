...
-> On fait une moyenne avec la valeur aberrante.
...
-> On remplace la (ou les) valeurs abérentes par NA (les valeurs aberantes etant $out)
...
-> On remplace la valeur NA par la moyenne calculée
...
On supprimme les colonnes ne contenant que des Na
...
donneefinNa = donneefin[donneefin == -999] <- NA
donneefinNa

-> On compte le nombre de NA dans chaque colonne et on enleve les colonnes avec seulement des NA

donneefin2 = donneefinNa[ , ! apply( donneefinNa , 2 , function(donneefinNa) all(is.na(donneefinNa)))]
donneefin2
