...
# Taux de bien prédit pour différents nombres de neurones pour 1 neurone
```{r}
...
# Taux de bien prédit pour différents 2n/n nombres de neurones pour 2 couches
```{r}
...
# Taux de bien prédit pour différents n/2n nombres de neurones pour 2 couches
```{r}
