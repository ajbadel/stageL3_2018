...
- ACP => nécessité de normaliser les données
- boxplot des descripteurs => normalisé et non normalisé
...
cf cours NN de M. Guyon (mail)

- image un neurone = boite noire avec entrée et sortie
- image un réseau de neurone, entrées, sortie, couches et nb de neurones

si tu reprends des images de qqn, pense à les citer.

## Le package `neuralnet`

## Echantillons d'apprentissage versus échantillon de validation

## La table de confusion et les critères calculés
table théorique et formule des critères

## La courbe ROC

- exemple avec deux courbes, une proche de la médiane = BOF, une proche de perpendiculaire = SUPER.
...
- plusieurs essais
  - 1 neurone
  - 1 couche, x neurones
  - 2 couches et x neurones
  
- je vous montre le  meilleur au sens de ...
- et le  plus simple possible, ici le moins de neurones/couches possibles
