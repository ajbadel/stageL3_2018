...
Dans certaines données, il y a des valeurs manquantes qu'on ne peut pas traiter et sont remplacés par -999. SI une colonne contenant au moins une valeur manquante, alors il faudra supprimer la colonne. 
